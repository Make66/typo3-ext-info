...
class Sha1Controller extends ActionController
{
     ...
     * cd ./vendor
     * find ./typo3 -type f -name "*.php" -exec sha1sum {} \; | gzip > /Users/martin/github/typo3-ext-sysinfo/Resources/Private/SHA1/12.4.16/typo3_files_php.txt.gz
     * find ./typo3 -type f -name "*.js" -exec sha1sum {} \; | gzip > /Users/martin/github/typo3-ext-sysinfo/Resources/Private/SHA1/12.4.16/typo3_files_js.txt.gz
